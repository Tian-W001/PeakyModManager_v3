  ...
  return (
    <>
      <div
        ...
        className={`${getBorderStyle(currentModState)} flex aspect-2/3 h-[350px] flex-col items-center overflow-hidden rounded-[30px_0] border-8 bg-[#333]`}
      >
        <img
        ...
        <div className="flex w-full flex-1 flex-col px-3 py-1.5">
          <div className="flex flex-row items-end">
            <div className="absolute">
              <img alt="avatar" className="aspect-square w-12 rounded-full bg-blue-50 ring" />
            </div>
            <span className="ml-13 flex-1 font-bold text-[#666] shadow-[0_1px_0_#666]">
